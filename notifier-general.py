        ...
        for site in sites:
            if site.get('enabled'):
                ...
                try:
                    ...
                    print("\t\t{}".format(e))
                    continue
                if site.get('detection_method') == 'positive':
                    ...
                    if alert_on_found and index != -1 :
                        ...
                        alert(site)
                elif site.get('detection_method') == 'negative':
                    notkeyword = site.get('notkeyword')
                    alert_on_found = site.get('alert')
                    notindex = html.upper().find(notkeyword.upper())
                    if alert_on_found and notindex == -1 :
                        alert(site)
